// constants/scienceContents.ts

/**
 * Science Hub content blocks.
 * Paragraph blocks now support basic inline markdown: **bold** and *italic*.
 */
...
export const FALLBACK_ARTICLES: Record<string, ScienceArticle> = {
  bulk_engine_physics: {
    slug: "bulk_engine_physics",
    title: "The Physics of Bulk Fermentation: Thermal Mass & Rate Tracking",
    blocks: [
      {
        type: "paragraph",
